...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "[&_a]:hover:text-foreground h-(--accordion-panel-height) px-[26px] pt-1 pb-5 data-ending-style:h-0 data-starting-style:h-0 [&_a]:underline [&_a]:underline-offset-3 [&_p:not(:last-child)]:mb-4",
          className,
        )}
      >
        {children}
