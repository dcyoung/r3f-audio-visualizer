...
const SheetHiddenRoot = VisuallyHiddenRoot;
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps & { insertHidden?: boolean }
>(({ insertHidden, side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    ...
    >
      {insertHidden && (
        <>
          <SheetTitle>
            <SheetHiddenRoot>Nav Menu</SheetHiddenRoot>
          </SheetTitle>
          <SheetDescription>
            <SheetHiddenRoot>Nav Menu</SheetHiddenRoot>
          </SheetDescription>
