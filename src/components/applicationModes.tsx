...
const getSupportedApplicationModes = (): string[] => {
    ...
    return navigator.platform.toLowerCase().startsWith("ip")
        ...
        : [APPLICATION_MODE_WAVE_FORM, APPLICATION_MODE_LIVE_STREAM, APPLICATION_MODE_MICROPHONE];
}

const isAudioMode = (mode: string): boolean => {
    return mode === APPLICATION_MODE_LIVE_STREAM || mode === APPLICATION_MODE_MICROPHONE;
}
